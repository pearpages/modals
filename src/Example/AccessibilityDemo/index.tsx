  ...
  return (
    <Modal id="accessibility-complete">
      <ModalContent>
        ...
        <ModalFooter>
          <button className="accessibility-demo__button accessibility-demo__button--secondary accessibility-demo__button--margin-right">
            Cancel
          </button>
          <button className="accessibility-demo__button accessibility-demo__button--danger">
            Delete Account
          </button>
        </ModalFooter>
      </ModalContent>
...
export function AccessibilityDemo() {
  return (
    <div className="accessibility-demo">
      ...
      <p className="accessibility-demo__description">
