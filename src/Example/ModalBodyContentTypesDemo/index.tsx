    ...
    <ModalSystem>
      ...
      >
        ...
        <div className="modal-body-content-types-demo__goals">
          <h4 className="modal-body-content-types-demo__goals-title">🎯 Content Type Testing Goals:</h4>
          <ul className="modal-body-content-types-demo__goals-list">
            <li className="modal-body-content-types-demo__goal">
              ✅ <strong>Media handling:</strong> Images, videos maintain aspect ratios
            </li>
            <li className="modal-body-content-types-demo__goal">
              ✅ <strong>Horizontal overflow:</strong> Wide content doesn't break modal layout
            </li>
            <li className="modal-body-content-types-demo__goal">
              ✅ <strong>Responsive behavior:</strong> Content adapts properly on mobile
            </li>
            <li className="modal-body-content-types-demo__goal">
              ✅ <strong>Scroll behavior:</strong> Proper scrolling for different content types
            </li>
            <li className="modal-body-content-types-demo__goal">
              ✅ <strong>Fixed positioning:</strong> Elements position correctly within modal
            </li>
            <li className="modal-body-content-types-demo__goal">
              ✅ <strong>Edge cases:</strong> Empty content, minimal content handled gracefully
            </li>
          </ul>
        </div>
