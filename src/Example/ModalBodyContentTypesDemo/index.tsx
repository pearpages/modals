      ...
      >
        ...
        <div className="modal-body-content-types-demo__goals">
          ...
          <ul className="modal-body-content-types-demo__goals-list">
            ...
            <li className="modal-body-content-types-demo__goal">
              ✅ <strong>Horizontal overflow:</strong> Wide content doesn't
              break modal layout
            </li>
            <li className="modal-body-content-types-demo__goal">
              ✅ <strong>Responsive behavior:</strong> Content adapts properly
              on mobile
            </li>
            <li className="modal-body-content-types-demo__goal">
              ✅ <strong>Scroll behavior:</strong> Proper scrolling for
