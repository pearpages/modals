  ...
  return (
    ...
    >
      <div className="mobile-responsive-test__instructions">
        <strong className="mobile-responsive-test__instructions-title">📋 Test Instructions:</strong>
        <ol className="mobile-responsive-test__instructions-list">
          <li className="mobile-responsive-test__instruction">
            <strong>Desktop</strong> (&gt;768px): Modal should be centered, sized normally
          </li>
          <li className="mobile-responsive-test__instruction">
            <strong>Mobile</strong> (≤768px): Modal should be fullscreen (100vw × 100vh)
          </li>
          <li className="mobile-responsive-test__instruction">
