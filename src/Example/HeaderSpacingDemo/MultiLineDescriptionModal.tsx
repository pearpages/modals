    ...
    <Modal id="multiline-desc" open={open} onOpenChange={setOpen}>
      <Modal.Content size="md">
        <Modal.Header>
          ...
          <Modal.Description>
            This is a longer description that spans multiple lines to
            demonstrate how the header spacing optimization handles more complex
            layouts. The description should wrap gracefully while maintaining
            proper spacing relationships with both the title above and the close
            button.
          </Modal.Description>
          <Modal.Close />
        </Modal.Header>
        <Modal.Body>
          <div className="header-spacing-demo__modal-content">
            <p>
              This modal tests complex header layouts with multi-line
              descriptions.
            </p>
            <Box variant="success" title="📋 Layout Features:">
              <ul>
