...
const MockModal: React.FC<{
...
}> = ({ id, children, closeOnBackdrop, closeOnEscape, onInteractOutside }) => {
  ...
  return createPortal(
    <div
      className="mock-modal__backdrop"
      onClick={(e) => {
