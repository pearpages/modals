    ...
    >
      ...
      {message && (
        <div className="programmatic-modal-example__status">
          <span className="programmatic-modal-example__status-text">{message}</span>
          <button
            onClick={clearMessage}
      ...
      <div className="programmatic-modal-example__states">
        <strong className="programmatic-modal-example__states-title">Modal States:</strong>
        <ul className="programmatic-modal-example__states-list">
          <li className="programmatic-modal-example__state">
            <span className="programmatic-modal-example__state-label">Info Modal:</span>
            <span className={`programmatic-modal-example__state-indicator ${
              modalStack.isOpen('info-modal') ? 'programmatic-modal-example__state-indicator--open' : 'programmatic-modal-example__state-indicator--closed'
            }`}>
              {modalStack.isOpen('info-modal') ? '🟢 Open' : '🔴 Closed'}
            </span>
          </li>
          <li className="programmatic-modal-example__state">
            <span className="programmatic-modal-example__state-label">Confirm Modal:</span>
            <span className={`programmatic-modal-example__state-indicator ${
              modalStack.isOpen('confirm-modal') ? 'programmatic-modal-example__state-indicator--open' : 'programmatic-modal-example__state-indicator--closed'
            }`}>
      ...
      <div className="programmatic-modal-example__usage">
        <strong className="programmatic-modal-example__usage-title">💡 Usage Examples:</strong>
        <ul className="programmatic-modal-example__usage-list">
          <li><code>modalStack.open('modal-id')</code> - Opens a modal</li>
          <li><code>modalStack.close('modal-id')</code> - Closes a modal</li>
          <li><code>modalStack.isOpen('modal-id')</code> - Checks if modal is open</li>
          <li><code>modalStack.toggle('modal-id')</code> - Toggles modal state</li>
        </ul>
      </div>
